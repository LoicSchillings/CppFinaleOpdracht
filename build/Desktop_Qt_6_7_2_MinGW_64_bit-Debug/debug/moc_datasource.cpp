...
struct qt_meta_stringdata_CLASSDataSourceENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDataSourceENDCLASS = QtMocHelpers::stringData(
    "DataSource",
    "generateData",
    "",
    "type",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDataSourceENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject DataSource::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSDataSourceENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDataSourceENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDataSourceENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void DataSource::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->generateData((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[3]))); break;
...
void *DataSource::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDataSourceENDCLASS.stringdata0))
